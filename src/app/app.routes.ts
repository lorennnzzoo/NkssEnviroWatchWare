...
export const routes: Routes = [
    ...
    { path: 'Station/All', component: ListStationsComponent, canActivate: [AuthGuard] },
    { path: 'Station/Add', component: AddStationComponent, canActivate: [AuthGuard] },
    { path: 'Channel/All', component: ListChannelsComponent, canActivate: [AuthGuard] },
    { path: 'Channel/Add', component: AddChannelComponent, canActivate: [AuthGuard] },
